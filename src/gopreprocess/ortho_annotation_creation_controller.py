...
def dump_converted_annotations(converted_target_annotations: List[List[str]], source_taxon: str, target_taxon: str) -> None:
    ...
    """
    # using pandas to take advantage of pystow in terms of file location and handling
    ...
    # to get the new file we have to create to add the header via pystow, so everything is managed together
    ...
    # here's the final writing to the final file
...
class AnnotationCreationController:
    ...
    def convert_annotations(self) -> None:
        ...
        # need to download and store the gene ontology JSON file used to create the closure in the
        # GoAspector object.
    ...
    def generate_annotation(
        ...
        """
        # make with_from include the original source annotation identifier if the
