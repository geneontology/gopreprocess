...
MOCK_ORTHOLOG_DATA = {
    ...
    "data": [
        {"Gene1ID": "MGI:1270148", "Gene1SpeciesTaxonID": "NCBITaxon:10090", "Gene2ID": "SGD:S000002810",
         "Gene2SpeciesTaxonID": "NCBITaxon:559292"}
    ]
}

# Mock target genes
MOCK_TARGET_GENES = {"MGI:MGI:1270148": {
        "id": "MGI:MGI:1270148",
...
def test_initialization(mock_file):
    ortho_processor = OrthoProcessor(target_genes=MOCK_TARGET_GENES,
                                     filepath=Path("fake/path"),
                                     taxon1="NCBITaxon:10090",
                                     taxon2="NCBITaxon:559292")
